<template>
  <v-app class="white">
    <v-toolbar
      v-if="($route.path !== '/' && !$route.path.match(/test|software|subject|faculty|new|discipline/gi)) && !$vuetify.breakpoint.xs || ($vuetify.breakpoint.xs && $route.path.indexOf('search')!== -1)"
