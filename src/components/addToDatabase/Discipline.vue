<template>
  <v-layout column>
    <v-text-field v-model="discipline.name" label="Название" solo/>
    <v-text-field v-model="discipline.description" label="Описание" maxlength="500" solo/>
    ...
    <v-data-table :headers="headers" :items="allDiscipline" class="elevation-0" hide-actions>
